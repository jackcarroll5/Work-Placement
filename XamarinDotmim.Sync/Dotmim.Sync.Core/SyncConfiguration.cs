...
/*Identical parameters for Server and Client
 Set by Server and overrides all Clients config*/
namespace Dotmim.Sync
{
    ...
    public class SyncConfiguration
    {
        ...
        /// <summary>
        /// Specify a prefix for naming stored procedure/trigger. Default is empty string
        /// </summary>
        [DataMember(Name = "TP")]
        ...
        /// <summary>
        /// Specify a suffix for naming stored procedures/trigger. Default is empty string
        /// </summary>
        [DataMember(Name = "TS")]
